...
/**
 * print_error - prints an error messsage
 * @info: the parameter an the return info struct
...
char *convert_number(long int num, int base, int flags)
{
	...
	if (!(flags & CONERT_UNSIGNED) && num < 0)
	{
		n = -num;
		sign = '-';
	}
...
/**
 * remove_comments - function replace first instance of 'a' with '\0'
 * @buf: address of the string to modifiy
 *
 * Return: Always 0;
 */
